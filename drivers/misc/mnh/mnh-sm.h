...
#define HW_MNH_KERNEL_DOWNLOAD		0x40200000
#ifdef CONFIG_MNH_SM_LARGE_KERNEL
#define HW_MNH_DT_DOWNLOAD		0x40080000
#define HW_MNH_RAMDISK_DOWNLOAD		0x40090000
#else
#define HW_MNH_DT_DOWNLOAD		0x41200000
#define HW_MNH_RAMDISK_DOWNLOAD		0x41210000
#endif
